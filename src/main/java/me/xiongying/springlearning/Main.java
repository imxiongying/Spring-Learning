...
//    }
    ...
    public static void main(String[] args) {
        ...
        testEventPublisherAware.sendMsg("这是第1条测试消息");
        testEventPublisherAware.sendMsg("这是第2条测试消息");
        testEventPublisherAware.sendMsg("这是第3条测试消息");
        testEventPublisherAware.sendMsg("这是第4条测试消息");
        testEventPublisherAware.sendMsg("这是第5条测试消息");
